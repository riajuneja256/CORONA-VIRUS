...
import {Success,shiftBox,cancelShift} from  './actions';
import './body.css';
                ...
                <div className="col s12 padding_0 divider_style">
                    ...
                    <div className="col s12 padding_0 blah">
                        ...
                        <div className="col s5 total_style right-align">
                            {this.props.global_data.confirmed - this.props.global_data.recovered - this.props.global_data.death}
                        </div>
                    </div>
                    ...
                    <div className="col s12 padding_0"  style = {{marginBottom: 16}}>
                        ...
                        <div className="col s5 total_style right-align">
                        {this.props.global_data.death}
                        </div>
                    </div>
                </div>
                <div id="area" className = "col s12 overflow_style">
                    <div className="col s12 browse">Browse</div>
                    <div className="area selected col s12" onClick = {() => this.props.cancelShift(this.props.global_data)}>
                    ...
                    <div className="col s6 right-align">{this.props.shift_box_data}</div>
                        </div>:
                        ""
                    }
                    ...
                    {
                        this.props.countries_key.map(el => (
...
const mapStateToProps = (reducerData) => {
    console.log()
    return {
      global_data: reducerData.ourReducer.global_data,
      heading: reducerData.ourReducer.heading,
      shift: reducerData.ourReducer,
      shift_box_data: reducerData.ourReducer.shiftData.confirmed,
